...
EOD;
     ...
     *
     */
    public function print_editpage_header() {
    ...
    /**
     * Basic header for the responses page
     *
     */
    public function responses_header() {
        $this->base_header('responses');
    }
    ...
    public function report_home() {
        ...
        $gradestable = new \mod_activequiz\tableviews\overallgradesview('gradestable', $this->rtq, $this->pageurl);
     ...
     *
     */
    public function responses_footer() {
        $this->base_footer();
    }

    /** End responses page functions */
